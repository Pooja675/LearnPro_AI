    ...
    <div className="max-w-3xl mx-auto px-6 py-8 space-y-6">
      ...
      <div className="space-y-2">
        ...
        <div className="w-full h-1.5 bg-slate-100 rounded-full overflow-hidden">
          <div
            className="h-full bg-linear-to-r from-indigo-400 to-indigo-500 rounded-full transition-all duration-500 ease-out"
            style={{
            ...
            return (
              <label
                ...
                className={`group relative flex items-center p-3 border-2 rounded-xl cursor-pointer transition-all duration-200 ${
                  isSelected
                    ? "border-emerald-500 bg-emerald-50 shadow-lg shadow-indigo-500/10"
              ...
              >
                ...
                {/* Custome Radion Button */}
                <div
                  className={`shrink-0 w-5 h-5 roun rounded-full border-2 transition-all duration-200 ${
                    isSelected
          ...
          {quiz.questions.map((_, index) => {
            ...
            return(
              <button
                ...
                disabled={submitting}
                className={`w-8 h-8 rounded-lg font-semobold text-xs transition-all duration-200 ${
                   isCurrent
                    ? 'bg-linear-to-r from-indigo-500 to-teal-500 text-white shadow-lg shadow-emerald-500/25 scale-110'
                    : isAnsweredQuestion
                    ? 'bg-emerald-100 text-indigo-700 hover:bg-emerald-200'
