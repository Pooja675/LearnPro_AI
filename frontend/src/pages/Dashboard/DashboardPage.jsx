...
const DashboardPage = () => {
  ...
  const stats = [
    ...
    },
    {
      ...
      shodowColor: "shadow-emerald-500/25",
    },
  ];

  return (
    <div className="min-h-full">
      <div className="absolute inset-0 bg-[radial-gradient(#e2e8f0_1px,transparent_1px)] bg-size-[20px_20px] opacity-40 pointer-events-none -z-10" />

      <div className="realtive max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-5">
          {stats.map((stat, index) => (
            <div key={index} className="group bg-white/80 backdrop-blur-sm border border-slate-200/60 rounded-2xl p-5 shadow-sm hover:shadow-md transition-all duration-300 ">
         ...
         <div className="bg-white/80 backdrop-blur-sm border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-8">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-xl bg-linear-to-r from-slate-100 to-slate-200 flex items-center justify-center">
